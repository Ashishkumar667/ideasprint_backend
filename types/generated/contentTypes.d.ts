...
export interface ApiDemoSchemaDemoSchema extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    files: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    TotalMoney: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSignUpSignUp extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Confirmpassword: Schema.Attribute.Password & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Email: Schema.Attribute.Email &
...
export interface ApiTransactionTransaction extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    pay_status: Schema.Attribute.String & Schema.Attribute.DefaultTo<'pending'>;
    publishedAt: Schema.Attribute.DateTime;
    receiptEmail: Schema.Attribute.Email;
    stripePaymentId: Schema.Attribute.UID;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    users_permissions_user: Schema.Attribute.Relation<
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    demo_schemas: Schema.Attribute.Relation<
      'oneToMany',
      'api::demo-schema.demo-schema'
    >;
    email: Schema.Attribute.Email &
